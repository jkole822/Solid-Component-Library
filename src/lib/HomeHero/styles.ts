...
before:-left-[60px]
before:absolute
before:bg-neutral-primary-50/40
before:h-px
before:top-1/2
before:w-[60px]
before:z-1
...
[&::selection]:bg-neutral-secondary-950
[&::selection]:text-neutral-primary-50

[&::-moz-selection]:bg-neutral-secondary-950
[&::-moz-selection]:text-neutral-primary-50
`;

export const CursorOneStyles = oneLine`
${SharedCursorStyles}

bg-neutral-primary-50
h-0
...
border-2
border-neutral-primary-200
home-hero-cursor-two
shadow-[0_0_22px_--alpha(var(--color-neutral-primary-50)_/_0.6)]

[&.hover]:bg-neutral-primary-50/10
[&.hover]:shadow-[0_0_12px_--alpha(var(--color-neutral-primary-50)_/_0.2)]
`;
...
[-webkit-writing-mode:vertical-lr]
[writing-mode:vertical-lr]
bg-[linear-gradient(90deg,_--alpha(var(--color-neutral-primary-400)_/_0),_--alpha(var(--color-neutral-primary-400)_/_0.35))]
fixed
font-black
h-[300%]
